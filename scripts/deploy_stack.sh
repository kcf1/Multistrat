#!/usr/bin/env bash
#
# Full local bootstrap: build app images, Alembic upgrade, asset seed, docker compose up.
# Run from repository root after copying .env.example -> .env and editing secrets.
#
# Usage:
#   ./scripts/deploy_stack.sh
#   ./scripts/deploy_stack.sh --no-build
#   ./scripts/deploy_stack.sh --destructive-seed
#   ./scripts/deploy_stack.sh --with-tools
#
