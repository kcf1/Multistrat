...
def test_basis_and_open_interest_series_defaults_align() -> None:
    ...
    assert BINANCE_FUTURES_30D_DATASET_BACKFILL_DAYS == 30
    assert BASIS_INITIAL_BACKFILL_DAYS == BINANCE_FUTURES_30D_DATASET_BACKFILL_DAYS
    assert OPEN_INTEREST_INITIAL_BACKFILL_DAYS == BINANCE_FUTURES_30D_DATASET_BACKFILL_DAYS
