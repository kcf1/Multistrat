...
def test_scheduler_cadence_is_module_constants() -> None:
    ...
    assert OHLCV_SCHEDULER_REPAIR_GAP_INTERVAL_SECONDS == 3600
    assert GLOBAL_PROVIDER_MAX_WORKERS == 16
    assert OHLCV_PROVIDER_MAX_WORKERS == GLOBAL_PROVIDER_MAX_WORKERS
    assert OHLCV_CORRECT_WINDOW_MAX_WORKERS == GLOBAL_PROVIDER_MAX_WORKERS
    assert OHLCV_REPAIR_GAP_MAX_WORKERS == GLOBAL_PROVIDER_MAX_WORKERS
    assert FUTURES_CORRECT_WINDOW_MAX_WORKERS == GLOBAL_PROVIDER_MAX_WORKERS
    assert FUTURES_REPAIR_GAP_MAX_WORKERS == GLOBAL_PROVIDER_MAX_WORKERS
    assert OHLCV_PROVIDER_MAX_IN_FLIGHT_FETCHES == 4
